...
/**
 * La clase SteelArmor representa una armadura de tipo acero en el juego.
...
public class SteelArmor extends Armor {
    ...
    /**
     * Constructor para crear una nueva instancia de SteelArmor.
     *
     ...
     * @param typeArmor   El tipo específico de la armadura (por ejemplo, "Acero").
     */
    ...
    /**
     * Inicializa el objeto SteelArmor. En este caso, no tiene implementación
