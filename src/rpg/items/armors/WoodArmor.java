...
/**
 * La clase WoodArmor representa una armadura de tipo madera en el juego.
...
public class WoodArmor extends Armor {
    ...
    /**
     * Constructor para crear una nueva instancia de WoodArmor.
     *
     ...
     * @param typeArmor   El tipo específico de la armadura (por ejemplo, "Madera").
     */
    ...
    /**
     * Inicializa el objeto WoodArmor. En este caso, no tiene implementación
